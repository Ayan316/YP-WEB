                  ...
                  >
                    {allSlides.map((s, i) => {
                      if (s.kind === 'image') {
                        return (
                          <div key={s.key} className={styles.sliderSlide}>
                            ...
                            <img className={styles.sliderImage} src={s.url} alt={`${detail.title} – image ${i + 1}`} loading={i === 0 ? undefined : 'lazy'} />
                          </div>
                        )
                      }
                      ...
                      if (s.kind === 'video') {
                        return (
                          <div key={s.key} className={styles.sliderSlide}>
                            <VideoPlayer src={s.url} title={s.name} active={i === slideIndex} />
                          </div>
                        )
                      }
                      if (s.kind === 'audio') {
                        return (
                          <div key={s.key} className={styles.sliderSlide}>
                            <div className={styles.bannerMediaWrap}>
                              <AudioPlayer src={s.url} active={i === slideIndex} />
                            </div>
                          </div>
                        )
                      }
                      ...
                      return (
                        <div key={s.key} className={styles.sliderSlide}>
                          <iframe
                            className={styles.bannerDocFrame}
                            src={docLiveSrc(s.url, s.kind as 'pdf' | 'document')}
                            title={s.name}
                          />
                        </div>
                      )
                    ...
                    {allSlides.map((s, i) => {
                      ...
                      return (
                        ...
                        >
                          {s.kind === 'image' ? (
                            /* eslint-disable-next-line @next/next/no-img-element */
                            <img className={styles.thumbImg} src={s.url} alt="" loading="lazy" />
                          ) : (
